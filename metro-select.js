...
(function (factory) {
    ...
    // jQuery object.
        ...
        factory(window.jQuery, window.jss, window, document);
    }
})(function ($, jss) {
    ...
    class MetroSelect {
        ...
        init() {
            ...
            for (var i = 0; i < children.length; i++) {
                ...
                var childElement = $(
                    `<span class='metro-select-child' ${child.style.cssText !== ''
        ...
        setAddRemoveVisibility(addElem,
            removeElem,
            visible) {
            if (visible) {
        ...
        set_class(childText, oldClass, newClass) {
